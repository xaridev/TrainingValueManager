...
namespace TrainingValueManager.Blazor.Server {
    public partial class TrainingValueManagerBlazorApplication : BlazorApplication {
        public TrainingValueManagerBlazorApplication() {
            InitializeComponent();
        }
        ...
        protected override void OnLoggingOn(LogonEventArgs args)
        {
            ...
            if(((AuthenticationStandardLogonParameters)args.LogonParameters).UserName == "Admin")
                myService.AddCS(((AuthenticationStandardLogonParameters)args.LogonParameters).UserName, "Training");
        }
        ...
        private void TrainingValueManagerBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
